        ...
        <div class="col_w900 float_l">
             ...
             <div>
                ...
                <p><b>MySqlBackup.NET</b> is a C# open source MySQL database backup and restore tool. 
                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                            <tr>
                                <td style="padding: 5px; border: 1px solid #5A6B7C; background-color: #465767;">
                                    <span style="font-weight:bold; color: #F7F7F7;">Simple Test (ASP.NET 4.5, MySqlBackup.NET 2.0.1)</span>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 5px; border: 1px solid #465767;">
                                    <b>MySQL Connection String</b>:<br />
                                    <asp:TextBox ID="txtConnString" runat="server" Font-Names="Courier New" Width="100%"></asp:TextBox><br />
                 ...
                 <br /><br />
                 <b>Acknowledgements for Free Web Hosting</b><br />
                 Special thanks to <a href="https://somee.com" target="_blank" style="color: #5c5c5c">somee.com</a> for providing free web hosting for this project to present a demo in ASP.NET.
            </div> 
        </div>
